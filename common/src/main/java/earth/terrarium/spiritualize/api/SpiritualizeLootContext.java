...
public class SpiritualizeLootContext extends LootContext {
    private int lootingAmount;
    private final LivingEntity entity;
    private final Map<LootContextParam<?>, Object> parameters;

    protected SpiritualizeLootContext(ServerLevel serverLevel, BlockPos blockPos, LivingEntity entity) {
    ...
    public static SpiritualizeLootContext of(ServerLevel serverLevel, SpiritualizationCoreBlockEntity spirtulizationCore) {
        Entity entity = spirtulizationCore.getEntityType().create(serverLevel);
        if (entity instanceof LivingEntity) {
            return new SpiritualizeLootContext(serverLevel, spirtulizationCore.getBlockPos(), (LivingEntity) entity);
        }
        return null;
    }
